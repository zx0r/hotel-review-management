  ...
  <table border="0">
    <tr>
      <td align="center" width="60%">
        ...
        <img src="public/assets/haviland-stand-mockup-sujet-marina-4096w.png" alt="A5 Acrylic Stand Mockup - Sujet Marina Hotel Da Nang By Haviland" width="100%" style="border-radius: 8px; box-shadow: 0 8px 24px rgba(0,0,0,0.12);" />
        <br/>
      ...
      <td align="center" width="40%">
        ...
        <br/>
        <em>Fig. 2: Master 4096×4096 QR code (Reed-Solomon Level H) with 30% error correction budget accommodating the central Haviland brand emblem.</em>
      </td>
    </tr>
  </table>
</div>
